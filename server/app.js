...
// --- Avatar storage ---
const avatarDir = paths.avatarDir;
...
const reminderTimer = setInterval(checkScheduledGameReminders, 5 * 60 * 1000);
reminderTimer.unref();
...
const achievementDir = paths.achievementDir;
...
module.exports = app;
module.exports.telegramPoll = telegramPoll;
